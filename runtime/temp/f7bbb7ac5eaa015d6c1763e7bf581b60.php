...
<div class="data-table table-striped">
    <form class="ids">
        <table>
            ...
            <tbody>
            <?php if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$fix): $mod = ($i % 2 );++$i;?>
            <tr>
                <td><input class="ids row-selected" type="checkbox" name="id[]" value="<?php echo $fix['id']; ?>"></td>
                <td><?php echo $fix['id']; ?></td>
                <td>
                    <a href="<?php echo url('index?pid='.$fix['id']); ?>"><?php echo $fix['title']; ?></a>
                </td>
                ...
                <td>
                    ...
                    <a class="confirm ajax-get" title="删除" href="<?php echo url('del?id='.$fix['id']); ?>">删除</a>
                </td>
            </tr>
