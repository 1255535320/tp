<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"E:\www\twothink\public/../application/home/view/default/fuwu\add.html";i:1512029729;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <div class="container-fluid">
        <form action="<?php echo url(); ?>" method="post">
            ...
            <div class="form-group">
                <label>电话(必填):</label>
                <input type="number" class="form-control" name="tel" value=""/>
            </div>
            <div class="form-group">
                <label>身份证号码:</label>
